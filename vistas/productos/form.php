                      ...
                      <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                            ...
                            <label  required class="col-lg-2 control-label" for="Cantidad">Cantidad</label>
                          <div class="col-lg-10">
                            <input required   required class="form-control" name="Cantidad" type="number" placeholder="Cantidad" value="<?=$p->getPro_can()?>">
